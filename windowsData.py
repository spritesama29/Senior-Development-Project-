...
class dataWindow(QWidget):
    ...
    def graph(self):
        ...
        posTVAxis = main.graphPosTVAxis(posTV)
        negTVAxis = main.graphNegTVAxis(negTV)
        posMOVAxis = main.graphPosMOVAxis(posMOV)
        negMOVAxis = main.graphNegMOVAxis(negMOV)
        posTVlen = main.graphPosTVlen(posTV)
        negTVlen = main.graphNegTVlen(negTV)
        posMOVlen = main.graphPosMOVlen(posMOV)
        negMOVlen = main.graphnegMOVlen(negMOV)
